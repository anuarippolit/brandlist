          ...
          {pattern.map((row, rowIndex) =>
            row.map((filled, colIndex) => (
              <div
                ...
                className={`w-[8px] h-[8px] sm:w-[10px] sm:h-[10px] md:w-3 md:h-3 lg:w-4 lg:h-4 xl:w-5 xl:h-5 flex-shrink-0 ${
  ...
  return (
    <nav className="w-full py-4 sm:py-6 md:py-8">
      <Link href="/home" passHref>
        <div className="flex items-center justify-center cursor-pointer" style={{ gap: '1px' }}>
